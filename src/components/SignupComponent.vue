    ...
    <div class="container">
      <transition-group name="slide-fade" mode="out-in" class="container">
        ...
        <div class="usernamePanel fade-in" v-if="continueValidated && !usernameValidated">
          ...
          <p class="username-instruction">
            Choose carefully! Your username will be visible to everyone.
          </p>
        ...
        <div class="vertical-divider" v-if="!continueValidated"></div>
        <!-- start of socials -->
  ...
  methods: {
    ...
    checkPasswordStrength() {
      ...
      if (!/[!@#$%^&*]/.test(this.password))
        this.tips.push("Include a special character");
    ...
    validateUsername(username) {
      ...
      if (filter.isProfane(username)) {
        return {
          valid: false,
          message: "Username cannot contain inappropriate language.",
        };
